...
//#endregion
export { RouteParamsRawGeneric as $, RouteRecordRedirectOption as $t, MatcherPatternPathDynamic_ParamOptions as A, RouteLocationAsRelativeTyped as At, isNavigationFailure as B, RouteLocationNormalizedLoadedTyped as Bt, START_LOCATION_NORMALIZED as C, RouteLocation as Ct, MatcherPatternHash as D, RouteLocationAsPathTypedList as Dt, MatcherPattern as E, RouteLocationAsPathTyped as Et, RouterScrollBehavior as F, RouteLocationGeneric as Ft, RouteLocationMatched as G, RouteLocationResolved as Gt, MatcherLocation as H, RouteLocationNormalizedTyped as Ht, ErrorTypes as I, RouteLocationNormalized as It, RouteLocationPathRaw as J, RouteLocationResolvedTypedList as Jt, RouteLocationNamedRaw as K, RouteLocationResolvedGeneric as Kt, NavigationFailure as L, RouteLocationNormalizedGeneric as Lt, MatcherQueryParams as M, RouteLocationAsString as Mt, MatcherQueryParamsValue as N, RouteLocationAsStringTyped as Nt, MatcherPatternPath as O, RouteLocationAsRelative as Ot, ParamParser as P, RouteLocationAsStringTypedList as Pt, RouteParamsGeneric as Q, RouteRecordNameGeneric as Qt, NavigationFailureType as R, RouteLocationNormalizedLoaded as Rt, PARAM_PARSER_BOOL as S, NavigationHookAfter as St, MatcherParamsFormatted as T, RouteLocationAsPathGeneric as Tt, MatcherLocationAsPath as U, RouteLocationNormalizedTypedList as Ut, LocationAsRelativeRaw as V, RouteLocationNormalizedLoadedTypedList as Vt, RouteComponent as W, RouteLocationRaw as Wt, RouteParamValue as X, RouteLocationTypedList as Xt, RouteMeta as Y, RouteLocationTyped as Yt, RouteParamValueRaw as Z, RouteRecordName as Zt, MatcherPatternQueryParam as _, NavigationGuard as _t, EXPERIMENTAL_RouteRecord_Base as a, RouteRecordInfoGeneric as an, RouteRecordSingleView as at, defineQueryParamParser as b, NavigationGuardReturn as bt, EXPERIMENTAL_Router as c, LocationQueryRaw as cn, _RouteRecordBase as ct, EXPERIMENTAL_Router_Base as d, parseQuery as dn, RouterMatcher as dt, _RouteRecordProps as en, RouteQueryAndHash as et, experimental_createRouter as f, stringifyQuery as fn, createRouterMatcher as ft, MatcherPatternQuery as g, RouteRecordNormalized as gt, createFixedResolver as h, RouteRecord as ht, EXPERIMENTAL_RouteRecordRaw as i, RouteRecordInfo as in, RouteRecordRedirect as it, MatcherPatternPathStatic as j, RouteLocationAsRelativeTypedList as jt, MatcherPatternPathDynamic as k, RouteLocationAsRelativeGeneric as kt, EXPERIMENTAL_RouterOptions as l, LocationQueryValue as ln, HistoryState as lt, normalizeRouteRecord as m, _PathParserOptions as mt, EXPERIMENTAL_RouteRecordNormalized_Group as n, RouteMap as nn, RouteRecordMultipleViewsWithChildren as nt, EXPERIMENTAL_RouteRecord_Group as o, TypesConfig as on, RouteRecordSingleViewWithChildren as ot, mergeRouteRecord as p, PathParserOptions as pt, RouteLocationOptions as q, RouteLocationResolvedTyped as qt, EXPERIMENTAL_RouteRecordNormalized_Matchable as r, RouteMapGeneric as rn, RouteRecordRaw as rt, EXPERIMENTAL_RouteRecord_Matchable as s, LocationQuery as sn, _RouteLocationBase as st, EXPERIMENTAL_RouteRecordNormalized as t, _Awaitable as tn, RouteRecordMultipleViews as tt, EXPERIMENTAL_RouterOptions_Base as u, LocationQueryValueRaw as un, RouterHistory as ut, defineParamParser as v, NavigationGuardNext as vt, EmptyParams as w, RouteLocationAsPath as wt, PARAM_PARSER_INT as x, NavigationGuardWithThis as xt, definePathParamParser as y, NavigationGuardNextCallback as yt, NavigationRedirectError as z, RouteLocationNormalizedLoadedGeneric as zt };