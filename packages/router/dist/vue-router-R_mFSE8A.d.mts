 ...
 * @license MIT
 */
import { $ as RouteParamsRawGeneric, $t as RouteRecordRedirectOption, At as RouteLocationAsRelativeTyped, B as isNavigationFailure, Bt as RouteLocationNormalizedLoadedTyped, C as START_LOCATION_NORMALIZED, Ct as RouteLocation, Dt as RouteLocationAsPathTypedList, Et as RouteLocationAsPathTyped, F as RouterScrollBehavior, Ft as RouteLocationGeneric, G as RouteLocationMatched, Gt as RouteLocationResolved, H as MatcherLocation, Ht as RouteLocationNormalizedTyped, I as ErrorTypes, It as RouteLocationNormalized, J as RouteLocationPathRaw, Jt as RouteLocationResolvedTypedList, K as RouteLocationNamedRaw, Kt as RouteLocationResolvedGeneric, L as NavigationFailure, Lt as RouteLocationNormalizedGeneric, Mt as RouteLocationAsString, Nt as RouteLocationAsStringTyped, Ot as RouteLocationAsRelative, Pt as RouteLocationAsStringTypedList, Q as RouteParamsGeneric, Qt as RouteRecordNameGeneric, R as NavigationFailureType, Rt as RouteLocationNormalizedLoaded, St as NavigationHookAfter, Tt as RouteLocationAsPathGeneric, U as MatcherLocationAsPath, Ut as RouteLocationNormalizedTypedList, V as LocationAsRelativeRaw, Vt as RouteLocationNormalizedLoadedTypedList, W as RouteComponent, Wt as RouteLocationRaw, X as RouteParamValue, Xt as RouteLocationTypedList, Y as RouteMeta, Yt as RouteLocationTyped, Z as RouteParamValueRaw, Zt as RouteRecordName, _t as NavigationGuard, an as RouteRecordInfoGeneric, at as RouteRecordSingleView, bt as NavigationGuardReturn, cn as LocationQueryRaw, ct as _RouteRecordBase, d as EXPERIMENTAL_Router_Base, dn as parseQuery, dt as RouterMatcher, en as _RouteRecordProps, et as RouteQueryAndHash, fn as stringifyQuery, ft as createRouterMatcher, gt as RouteRecordNormalized, ht as RouteRecord, in as RouteRecordInfo, it as RouteRecordRedirect, jt as RouteLocationAsRelativeTypedList, kt as RouteLocationAsRelativeGeneric, ln as LocationQueryValue, lt as HistoryState, mt as _PathParserOptions, nn as RouteMap, nt as RouteRecordMultipleViewsWithChildren, on as TypesConfig, ot as RouteRecordSingleViewWithChildren, pt as PathParserOptions, q as RouteLocationOptions, qt as RouteLocationResolvedTyped, rn as RouteMapGeneric, rt as RouteRecordRaw, sn as LocationQuery, st as _RouteLocationBase, tn as _Awaitable, tt as RouteRecordMultipleViews, u as EXPERIMENTAL_RouterOptions_Base, un as LocationQueryValueRaw, ut as RouterHistory, vt as NavigationGuardNext, wt as RouteLocationAsPath, xt as NavigationGuardWithThis, yt as NavigationGuardNextCallback, z as NavigationRedirectError, zt as RouteLocationNormalizedLoadedGeneric } from "./router-CKNdOxgP.mjs";
...
interface Router extends EXPERIMENTAL_Router_Base<RouteRecordNormalized> {
   ...
   */
  pushAddLayer(to: RouteLocationRaw): Promise<NavigationFailure | void | undefined>;
  /**
   * Add a new layer and replace current navigation.
   */
  replaceAddLayer(to: RouteLocationRaw): Promise<NavigationFailure | void | undefined>;
  /**
   ...
   */
  pushLayer(layer: number, to: RouteLocationRaw): Promise<NavigationFailure | void | undefined>;
  /**
   * Navigate a specific layer and replace current navigation.
   */
  replaceLayer(layer: number, to: RouteLocationRaw): Promise<NavigationFailure | void | undefined>;
  /**
   * Navigate all layers at once.
   */
  pushAllLayers(locations: RouteLocationRaw[]): Promise<NavigationFailure | void | undefined>;
  /**
   * Navigate all layers at once and replace current navigation.
   */
  replaceAllLayers(locations: RouteLocationRaw[]): Promise<NavigationFailure | void | undefined>;
  /**
