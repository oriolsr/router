...
function decode(text) {
	...
	try {
		...
		__DEV__ && warn$1(`Error decoding "${text}". Using original value`);
	}
	return "" + text;
}
...
function scrollToPosition(position) {
	...
	if ("el" in position) {
		...
		*/
		...
		if (!el) {
			__DEV__ && warn$1(`Couldn't find element using selector "${position.el}" returned by scrollBehavior.`);
			return;
		}
...
function onBeforeRouteLeave(leaveGuard) {
	...
	if (!activeRecord) {
		__DEV__ && warn$1("No active route record was found when calling `onBeforeRouteLeave()`. Make sure you call this function inside a component child of <router-view>. Maybe you called it inside of App.vue?");
		return;
	}
...
function onBeforeRouteUpdate(updateGuard) {
	...
	const activeRecord = inject(matchedRouteKey, {}).value;
	if (!activeRecord) {
		__DEV__ && warn$1("No active route record was found when calling `onBeforeRouteUpdate()`. Make sure you call this function inside a component child of <router-view>. Maybe you called it inside of App.vue?");
		return;
	}
...
function extractComponentsGuards(matched, guardType, to, from, runWithContext = (fn) => fn()) {
	...
	for (const record of matched) {
		if (__DEV__ && !record.components && (!record.children || record.children.length === 0) && record.path !== "") warn$1(`Record with path "${record.path}" is either missing a "component(s)" or "children" property.`);
...
//#endregion
export { isArray as $, scrollToPosition as A, isSameRouteRecord as B, isNavigationFailure as C, getSavedScrollPosition as D, computeScrollPosition as E, normalizeBase as F, decode as G, resolveRelativePath as H, NEW_stringifyURL as I, encodePath as J, encodeHash as K, START_LOCATION_NORMALIZED as L, NavigationType as M, START as N, getScrollKey as O, createHref as P, identityFn as Q, isSameRouteLocation as R, createRouterError as S, isRouteName as T, stringifyURL as U, parseURL as V, stripBase as W, applyToParams as X, warn$1 as Y, assign as Z, normalizeQuery as _, guardToPromiseFnWithLayers as a, ErrorTypes as b, onBeforeRouteUpdate as c, routeLocationKey as d, mergeOptions as et, routerKey as f, viewDepthKey as g, routerViewLocationKey as h, guardToPromiseFn as i, NavigationDirection as j, saveScrollPosition as k, useCallbacks as l, routerRoutesKey as m, extractChangingRecords as n, isBrowser as nt, loadRouteLocation as o, routerLayerKey as p, encodeParam as q, extractComponentsGuards as r, onBeforeRouteLeave as s, addDevtools as t, noop as tt, matchedRouteKey as u, parseQuery as v, isRouteLocation as w, NavigationFailureType as x, stringifyQuery as y, isSameRouteLocationParams as z };